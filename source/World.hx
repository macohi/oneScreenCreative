...
class World
{
	public static var FORMAT_NUMBER:Int = 2;
	...
	// TODO: what to do about block variations
	...
	public static function parseWorldString(world:String)
	{
		...
		{
			var newBlock:Block = new Block(block.id, block.x * Block.BLOCK_DIMENSION, block.y * Block.BLOCK_DIMENSION, false);
